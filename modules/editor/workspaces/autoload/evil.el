;;; editor/workspaces/autoload/evil.el -*- lexical-binding: t; -*-
;;;###if (modulep! :editor evil)

;;;###autoload (autoload '+workspace:save "editor/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:load "editor/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:new "editor/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:rename "editor/workspaces/autoload/evil" nil t)
(evil-define-command +workspace:rename (new-name)
  "Ex wrapper around `+workspace/rename'."
  (interactive "<a>") (+workspace/rename new-name))

;;;###autoload (autoload '+workspace:delete "editor/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:switch-next "editor/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:switch-previous "editor/workspaces/autoload/evil" nil t)
